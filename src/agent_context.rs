...
pub fn zsui_completion_areas() -> Vec<ZsuiCompletionArea> {
    vec![
        ...
        ZsuiCompletionArea {
            ...
            percent_complete: 71,
            status_name: "win32_view_click_text_and_toggle_input_ready",
            source_path: "src/native.rs",
            missing_before_complete: vec![
                "real native menus",
                "dialogs",
                "clipboard",
                "broader pointer/keyboard dispatch into ViewEventCx",
        ...
        ZsuiCompletionArea {
            ...
            percent_complete: 64,
            status_name: "win32_typed_control_input_dispatch_ready",
            ...
            missing_before_complete: vec![
                ...
                "connect full pointer/keyboard input dispatch to ViewEventCx beyond Win32 click/text/toggle routing",
        ...
        ZsuiCompletionArea {
            ...
            percent_complete: 51,
            status_name: "win32_view_click_text_toggle_and_status_popup_routes_ready",
            source_path: "src/windows_win32_host.rs",
            missing_before_complete: vec![
                "AppKit split",
                "GTK split",
                "richer Win32 pointer/keyboard/IME events",
        ...
        ZsuiCompletionArea {
            ...
            percent_complete: 67,
            status_name: "win32_typed_control_input_native_smoke_recorded",
