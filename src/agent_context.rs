...
mod tests {
    ...
    fn agent_context_exposes_all_standalone_platforms() {
        ...
        assert_eq!(context.readiness.component_catalog.first_pass_count, 33);
        assert_eq!(context.readiness.component_catalog.contract_only_count, 5);
        assert_eq!(context.readiness.component_catalog.not_started_count, 10);
