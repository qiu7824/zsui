...
pub fn zsui_rust_first_goals() -> Vec<ZsuiRustFirstGoal> {
    vec![
        ...
        ZsuiRustFirstGoal::new(
            ...
            "expand schema coverage beyond the first eleven Viewer components, extend stable-ID retention from focus and text-editor state to general scroll and advanced controls, then add deterministic AI handoff and release embedding; defer the full drag-and-drop editor",
        ),
        ZsuiRustFirstGoal::new(
