...
pub fn zsui_rust_first_goals() -> Vec<ZsuiRustFirstGoal> {
    vec![
        ...
        ZsuiRustFirstGoal::new(
            ...
            "keep all 48 catalog families, typed binding compatibility, stable-ID state retention, three-platform Viewer proof and release embedding aligned as components evolve; defer the full drag-and-drop editor",
        ),
        ZsuiRustFirstGoal::new(
