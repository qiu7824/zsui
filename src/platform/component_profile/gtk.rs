...
pub(super) const fn profile() -> PlatformComponentProfile {
    PlatformComponentProfile {
        ...
        typography: PlatformTypographyProfile {
            ...
            window_title: ZsTypographyMetrics::new(25.5, 32.0, TextWeight::Bold),
        ...
        badge: PlatformBadgeProfile {
            dot_diameter: Dp::new(6.0),
            minimum_diameter: Dp::new(18.0),
            horizontal_padding: Dp::new(6.0),
            vertical_padding: Dp::new(1.0),
            icon_size: Dp::new(12.0),
            digit_width: Dp::new(6.5),
        ...
        split_view: PlatformSplitViewProfile {
            preferred_pane_width: Dp::new(260.0),
        ...
        base_control: PlatformBaseControlProfile {
            metrics: ZsBaseControlMetrics {
                ...
                progress_indicator_height: Dp::new(4.0),
                progress_indeterminate: crate::ZsProgressBarIndeterminateMetrics {
                    cycle_ms: 1_600,
                    frame_interval_ms: 16,
                    primary: crate::ZsProgressBarSegmentMetrics {
                        width_fraction: 0.3,
                        start_offset_fraction: -0.3,
                        end_offset_fraction: 1.0,
                        delay_ms: 0,
                        duration_ms: 1_600,
                    },
                    secondary: None,
        ...
        accordion: PlatformAccordionProfile {
            header_height: Dp::new(34.0),
            header_padding_left: Dp::new(12.0),
            chevron_gap: Dp::new(8.0),
            chevron_button_size: Dp::new(28.0),
            chevron_glyph_size: Dp::new(12.0),
            chevron_margin_right: Dp::new(3.0),
        },
        #[cfg(feature = "tabs")]
        ...
        dialog: PlatformDialogProfile {
            ...
            metrics: ZsContentDialogMetrics {
                ...
                separator_thickness: Dp::new(0.0),
        ...
        workbench: PlatformWorkbenchProfile {
            sidebar_width: Dp::new(280.0),
            collapsed_sidebar_width: Dp::new(56.0),
            top_bar_height: Dp::new(56.0),
            composer_height: Dp::new(116.0),
            inspector_width: Dp::new(320.0),
            inspector_breakpoint: Dp::new(940.0),
            content_max_width: Dp::new(760.0),
            content_horizontal_inset: Dp::new(24.0),
            composer_vertical_inset: Dp::new(12.0),
            message_gap: Dp::new(16.0),
            message_vertical_inset: Dp::new(18.0),
