    ...
    PlatformComponentProfile {
        ...
        base_control: PlatformBaseControlProfile {
            metrics: ZsBaseControlMetrics {
                ...
                progress_slot_height: Dp::new(3.0),
                progress_track_height: Dp::new(1.0),
                ...
                progress_indeterminate: crate::ZsProgressBarIndeterminateMetrics {
                    ...
                    primary: crate::ZsProgressBarSegmentMetrics {
                        width_fraction: 0.4,
                        start_offset_fraction: -0.4,
                        end_offset_fraction: 1.2,
                        delay_ms: 0,
                        duration_ms: 1_500,
                    },
                    secondary: Some(crate::ZsProgressBarSegmentMetrics {
                        width_fraction: 0.6,
                        start_offset_fraction: -0.9,
                        end_offset_fraction: 0.996,
                        delay_ms: 750,
                        duration_ms: 1_250,
                    }),
                    easing: Some([0.4, 0.0, 0.6, 1.0]),
                },
        ...
        dialog: PlatformDialogProfile {
            ...
            metrics: ZsContentDialogMetrics {
                ...
                minimum_height: Some(Dp::new(184.0)),
                maximum_height: Some(Dp::new(756.0)),
                ...
                button_height: Dp::new(32.0),
                minimum_button_width: Dp::new(120.0),
                separator_thickness: Dp::new(1.0),
