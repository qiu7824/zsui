...
pub(super) const fn profile() -> PlatformComponentProfile {
    PlatformComponentProfile {
        ...
        typography: PlatformTypographyProfile {
            ...
            window_title: ZsTypographyMetrics::new(22.0, 26.0, TextWeight::Regular),
        ...
        badge: PlatformBadgeProfile {
            ...
            horizontal_padding: Dp::new(5.0),
            vertical_padding: Dp::new(2.0),
            icon_size: Dp::new(10.0),
            digit_width: Dp::new(5.5),
            text_line_height: Dp::new(13.0),
        ...
        base_control: PlatformBaseControlProfile {
            metrics: ZsBaseControlMetrics {
                ...
                progress_indicator_height: Dp::new(3.0),
