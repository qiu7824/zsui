...
catalog covers 48 WinUI-style families: 34 have a first-pass runtime surface, 5
have contracts only and 9 are not started. Composite shells can combine
working primitives, but they must not be used to claim that missing TreeView,
DataGrid, ColorPicker, flyout or WebView families are complete.
